...
INSERT INTO `coffeeshop`.`accounts` (`Acc_Id`, `Full_Name`, `Gender`, `Address`, `Phone_Number`, `Email`, `Birth_Date`, `Acc_Status`, `Position`, `User_Name`, `User_Password`) VALUES ('1', 'Nguyễn Xuân Mạnh', '1', '282 Lĩnh Nam', '0966853865', 'manhnx.nde19078@vtc.edu.vn', '2001/10/01', '1', '1', 'admin', '123456');
INSERT INTO `coffeeshop`.`accounts` (`Acc_Id`, `Full_Name`, `Gender`, `Address`, `Phone_Number`, `Email`, `Birth_Date`, `Acc_Status`, `Position`, `User_Name`, `User_Password`) VALUES ('2', 'Vũ Văn Thanh', '1', 'Hà Nội', '0956421578', 'thanhvv.nde19052@vtc.edu.vn', '1996/01/15', '1', '2', 'staff', '123456');
...
INSERT INTO `coffeeshop`.`cafe` (`Cafe_Id`, `Cafe_Name`, `Cafe_Price`, `Cafe_Amount`, `Cafe_Status`) VALUES ('1', 'Cafe đá', '10000', '100', '1');
INSERT INTO `coffeeshop`.`cafe` (`Cafe_Id`, `Cafe_Name`, `Cafe_Price`, `Cafe_Amount`, `Cafe_Status`) VALUES ('2', 'Cafe sữa', '10000', '100', '1');
INSERT INTO `coffeeshop`.`cafe` (`Cafe_Id`, `Cafe_Name`, `Cafe_Price`, `Cafe_Amount`, `Cafe_Status`) VALUES ('3', 'Cafe đen', '10000', '100', '1');
INSERT INTO `coffeeshop`.`cafe` (`Cafe_Id`, `Cafe_Name`, `Cafe_Price`, `Cafe_Amount`, `Cafe_Status`) VALUES ('4', 'Sinh tố bơ', '15000', '100', '1');
INSERT INTO `coffeeshop`.`cafe` (`Cafe_Id`, `Cafe_Name`, `Cafe_Price`, `Cafe_Amount`, `Cafe_Status`) VALUES ('5', 'Sinh tố dưa hấu', '15000', '100', '1');
...
INSERT INTO `coffeeshop`.`cafe` (`Cafe_Id`, `Cafe_Name`, `Cafe_Price`, `Cafe_Amount`, `Cafe_Status`) VALUES ('10', 'Cam ép', '10000', '100', '1');
...
constraint pk_Order_Details PRIMARY KEY (Order_Id, Cafe_Id),
...
-- PROCEDURE 
DELIMITER $$
CREATE PROCEDURE insertOrder(in acc_id int , in order_status varchar(255), in order_date varchar(11))
BEGIN 
	insert into order_drinks(acc_id,order_status,order_date) value(Acc_id,order_status,order_date);
END $$
DELIMITER ;
